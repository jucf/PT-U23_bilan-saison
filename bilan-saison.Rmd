...
Distribution hebdomadaire (Watts) et mensuelle (sRPE) selon le modèle à 3 zones [@Seiler2006-qa]. Les zones de puissance sont établies à partir d’une puissance critique de **`r cp`** Watts conformément aux pourcentages suivant: z1=0-75%, z2=76-105%, z3=106%-+. Votre puissance critique est estimée à partir de vos données de puissance records entre 3 et 20 minutes disponibles pour 2022.
