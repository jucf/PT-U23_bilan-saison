...
gg_kj <-
   ...
   scale_fill_manual(name = "",
                    ...
                    labels = "Données journalières",
                    drop = FALSE) +
   labs(y = "Kilojoules simplifiées (kJ)\n", x = "") +
...
```{r CP, fig.cap="Modèle avec la meilleure combinaison.", results = 'hide', fig.width=11, fig.height=4,}
...
df_z_p %>%
   ...
   footnote(
      general_title = "",
      general = "Les zones de puissane sont fondées sur le modèle de Coggan.",
      threeparttable = T,
      fixed_small_size = T
   )
```

Zones d'entraînement établies à partir d'une fréquence cardiaque maximale de **`r fc_max`** bpm
